...
const PendingCosting = () => {
    ...
    const fetchEnquiries = async () => {
        try {
            const res = await API.get(`/enquiries/?status=${encodeURIComponent('Pending with Costing')}&page_size=100&search=${encodeURIComponent(search)}`);
                                ...
                                {enquiries.length === 0 ? (
                                    <tr>
                                        <td colSpan="10" className="text-center p-5 text-muted">
                                            No enquiries pending with Costing.
                                        </td>
                                    </tr>
                                ) : (
