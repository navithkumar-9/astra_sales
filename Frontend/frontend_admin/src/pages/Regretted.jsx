...
const Regretted = () => {
    ...
    const fetchEnquiries = async () => {
        try {
            ...
            if (!params.status) params.status = 'Regretted';
            ...
            showToast('Failed to fetch Regretted enquiries.', 'error');
        } finally {
            setLoading(false);
        }
    };
    ...
    return (
        <div className="page container-fluid px-4 py-4">
            <div className="page-header d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h1 className="page-title h3 font-weight-bold mb-1">Regretted</h1>
                    <p className="page-subtitle text-muted mb-0">Manage project enquiries in Regretted stage</p>
                </div>
            </div>
            ...
            <EnquiryTable 
                ...
                data={enquiries}
                loading={loading}
                emptyMessage="No enquiries in Regretted stage."
                renderRow={(enq, idx) => (
                    <tr key={enq.id} className="modern-table-row">
                        ...
                        <td className="py-3 align-middle">
                            <StatusBadge status={enq.status || 'Regretted'} />
                        </td>
