...
class DashboardService:
    ...
    def calculate_stats():
        ...
        aggregates = qs.aggregate(
            ...
            todays_due=Count('id', filter=~Q(status__in=terminal_statuses) & Q(rfq_due_date=now_date)),
            tomorrow_due=Count('id', filter=~Q(status__in=terminal_statuses) & Q(rfq_due_date=tomorrow_date)),
